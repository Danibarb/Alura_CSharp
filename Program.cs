...
namespace POO1
{
    public class Program
    {
        ...
        {
            //Codigo com Using para substituir blocos verbosos com try/Catch/Finally
            ...
            contaBreno.Sacar(30);
            WriteLine("Saldo de {0} agora é de {1}",contaBreno.titular.Nome,contaBreno.saldo);
            ...
            ContaBruna.Transferir(59.95,contaBreno);

            //Sem arredondar saldos
            WriteLine("{0} fez uma transferência para {1}. Saldo atual de {2} é de R${3} e de {4} é de R${5}.", ContaBruna.titular.Nome,contaBreno.titular.Nome,ContaBruna.saldo,contaBreno.titular.Nome, contaBreno.saldo);

            //saldos arredondados
            WriteLine("{0} fez uma transferência para {1}. Saldo atual é de R${2}.", ContaBruna.titular.Nome,contaBreno.titular.Nome,ContaBruna.saldo.ToString("F"), contaBreno.titular.Nome,contaBreno.saldo.ToString("F"));
